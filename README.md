...
1. Vision Based Chess Manipulation Using SCARA Hardware:
   ...
   세부사항의 경우 vision-chess-manipulation-ros2/docs/pipeline.md에 정리하였습니다. 동일 내용 아래에도 첨부하였습니다.
...
2. Teleoperation Leader Arm:
   ...
   세부사항의 경우 teleop-leader-arm-ros2/docs/pipeline.md에 정리하였습니다. 동일 내용 아래에도 첨부하였습니다.
