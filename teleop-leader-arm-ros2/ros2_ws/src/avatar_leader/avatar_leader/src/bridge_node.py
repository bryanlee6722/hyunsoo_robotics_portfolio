...
class BridgeNode(Node):
    ...
    def __init__(self):
        ...
        # 포트 정보
        self.declare_parameter('serial_port', '/dev/ttyUSB_DEVICE')
        # 통신 속도
        ...
        self.declare_parameter('operation_mode', 4) 
        ...
        self.joint_names: List[str] = ["right_joint1", "right_joint2", "right_joint3", "right_joint4", "right_joint5", "right_joint6", "right_joint_gripper",
                                       "left_joint1", "left_joint2", "left_joint3", "left_joint4", "left_joint5", "left_joint6", "left_joint_gripper"]
